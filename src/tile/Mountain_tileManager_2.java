...
public class Mountain_tileManager_2 {
    ...
    public Mountain_tileManager_2(GamePanel panel) {
        this.panel = panel;
        tiles = new Tile[10];
    ...
    public void draw(Graphics2D g) {
        ...
        while (worldcol<5&&worldrow<GamePanel.maxworldrow) {
            ...
            int screenx=worldx- entity.worldx + Player.screenx+GamePanel.mountain_screenx_1;
            ...
            if (map[count]!=1 && map[count]!=2 && map[count]!=0) {
                ...
                switch (map[count]) {
                    ...
                    case 3:
                        g.drawImage(GamePanel.images.get("Mountain_2"), screenx-240, screeny+265, 1720, 300, null);
                        break;
